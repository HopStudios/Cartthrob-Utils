...
Custom plugin to get data from Cartthrob. It's pretty limited as I only needed 2 precise variables. It was needed because we're using *Cartthrob multi currencies* module.
